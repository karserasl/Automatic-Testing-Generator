...
if __name__ == '__main__':
    ...
    #         print(e)
    # import middleware.loader as l
    #
    # a = l.get_all_techniques()
    # print(a)
    a = ATG(
        'C:/Users/Administrator/Uni-3rd_Year/CTEC3451 - Development Project/Development/Code/Automatic Testing Generator/atg/sandbox.py')
    a.get_data()
